...
<div class="ngViewport" unselectable="on" ng-viewport ng-class="{'ui-widget-content': jqueryUITheme}" ng-style="viewportStyle()" unselectable="on" tabindex="0" style="width: 1099px; height: 154px;">
